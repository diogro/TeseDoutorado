...
Vou exemplificar alguns comandos básicos e úteis para uma dissertação como incluir citações \parencite{Sand-Jensen2007} ou ``aspas''.
...
O \texttt{natbib} é bastante flexível \parencite[ver detalhes em][]{Kirk2008}.
\textcite{Emlet1987} mostra outro modo de citar trabalhos no texto e como grafar o nome das espécies \emph{Drosophila melagonaster} e subde usando o comando \texttt{$\backslash$emph} e um comando customizado, respectivamente.
...
\textcite{Day2006} não usaram papilas de subsus.
