...
\noindent
Multivariate quantitative genetics provides a powerful framework for studying patterns and
...
to be largely successful, but the underlying genetics of multivariate
...
divergence is due to the different kinds of genetic and environmental effects. 
Finally, we also use these vectors to decompose patterns of genetic covariation and examine the
...
of selection and divergence. Pleiotropic effects are highly variable but are, on
...
(see Fig.~\ref{fig:joh:covGP}). Matrix comparisons can be seen in Table~\ref{joh:matcompare}. The most
...
and decreasing late traits or \textit{vice-versa} (markers on the top-left and
