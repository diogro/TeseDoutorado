...
modular_col = "#D4CB39"
antagonistic_col = "#FF6DAE"
integrative_col = "#00B78D"
local_col = "#00BFFF"
...
save_plot("~/Dropbox/labbio/articles/TeseDoutorado/chapter_atchley/media/vector_classifcation_ilustration.png", vector_classification, base_height = 6, base_aspect_ratio = 1)
