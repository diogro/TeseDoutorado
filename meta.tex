...
%\addbibresource{chapter_JoH-Melo_etal/refs.bib}
%\addbibresource{chapter_bookoqya/refs.bib}
%\addbibresource{chapter_annual_review/refs.bib}
...
\newcommand{\titulo}{Evolução do mapa genótipo-fenótipo e da covariação genética}
